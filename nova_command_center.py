...
@media(max-width:1050px){.nova-command-center{grid-template-columns:1fr}.nova-quick{grid-template-columns:repeat(3,1fr)}}
...
function mount(){
 ...
 root.innerHTML='<div class="nova-ops-card"><div class="nova-health"><i class="nova-health-dot"></i><div><b id="nova-cc-state">Проверяем систему…</b><small id="nova-cc-detail">NOVA Command Center</small></div></div><div class="nova-score"><b id="nova-cc-score">—</b><small>Health Score</small></div><button type="button" class="btn secondary nova-cc-refresh" id="nova-cc-refresh">↻</button></div><div class="nova-quick"><a href="/clients"><strong>👥 Клиенты</strong><span>Управление VPN</span></a><a href="/traffic"><strong>📈 Traffic</strong><span>Живой трафик</span></a><a href="/doctor"><strong>🩺 Doctor</strong><span>Проверка и ремонт</span></a><a href="/diagnostics"><strong>✓ Диагностика</strong><span>Сеть и AWG</span></a><a href="/awg-toolza"><strong>🛠️ Toolza</strong><span>AWG 3.1 Center</span></a></div>';
