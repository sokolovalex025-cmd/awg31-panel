...
def apply(nova11):
    ...
    def nav(path):
        groups = [
            ...
            ('СИСТЕМА', [('⌘','Сеть и Firewall','/network'), ('◌','Live Traffic','/traffic'), ('✓','Диагностика','/diagnostics'), ('🧭','Центр состояния','/nova13-status'), ('🩺','NOVA Doctor','/doctor'), ('📡','Монитор подключений','/live-monitor'), ('🛠️','AWG Toolza','/awg-toolza'), ('▣','Резервные копии','/backups'), ('☷','Логи','/logs')]),
