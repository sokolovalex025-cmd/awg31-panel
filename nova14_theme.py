#!/usr/bin/env python3
"""NOVA 14 visual layer: Telegram plus robust sidebar layout fix."""
...
/* STATUS CARD MUST STAY IN SIDEBAR FLOW */
.server{
  ...
  top:auto !important;
  margin:22px 2px 6px !important;
  flex:0 0 auto !important;
}
.sidebar .server{width:auto !important}
.nav{padding-bottom:2px !important}
</style>'''
