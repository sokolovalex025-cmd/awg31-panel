...
.nc-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:13px}.nc-stat{padding:16px 17px;border:1px solid var(--line);border-radius:16px;background:#0d141e;box-shadow:0 9px 28px rgba(0,0,0,.18)}.nc-stat span{display:block;color:#8290a3;font-size:9px;font-weight:850;letter-spacing:.12em;text-transform:uppercase}.nc-stat b{display:block;margin-top:8px;font-size:24px}.nc-stat small{display:block;margin-top:4px;color:#7b899d;font-size:10px}
.nc-create{display:grid;grid-template-columns:1.1fr .9fr;gap:13px;margin-bottom:13px}.nc-panel{padding:18px;border:1px solid var(--line);border-radius:18px;background:#0d141e;box-shadow:0 9px 28px rgba(0,0,0,.18)}.nc-panel h2{margin:0;font-size:16px}.nc-muted{color:#8290a3;font-size:11px}.nc-form{display:grid;grid-template-columns:1fr auto;gap:10px;align-items:end;margin-top:13px}.nc-form label{margin:0 0 6px}.nc-hint{margin-top:13px;padding:12px;border-radius:12px;background:#101d2b;border:1px solid #24364b;color:#aab8c8;font-size:11px;line-height:1.6}
.nc-toolbar{display:flex;align-items:center;justify-content:space-between;gap:12px}.nc-search{width:min(310px,100%)}.nc-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:11px;margin-top:14px}.nc-client-card{border:1px solid var(--line);border-radius:16px;background:#0d141e;padding:15px;box-shadow:0 7px 22px rgba(0,0,0,.18);transition:.18s}.nc-client-card:hover{transform:translateY(-1px);box-shadow:0 11px 28px rgba(0,0,0,.28)}
.nc-client-top{display:flex;align-items:center;justify-content:space-between;gap:10px}.nc-client{display:flex;align-items:center;gap:10px;min-width:0}.nc-avatar{width:38px;height:38px;flex:0 0 38px;border-radius:12px;display:grid;place-items:center;background:linear-gradient(135deg,#10b981,#3b82f6);color:#fff;font-weight:900}.nc-name{font-weight:850;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nc-ip{font:11px Consolas,monospace;color:#8290a3}.nc-key{font:9px Consolas,monospace;color:#93a0b2;margin-top:2px}.nc-meta{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin-top:13px}.nc-meta-item{padding:9px;border-radius:11px;background:#111a26;border:1px solid #1c2633}.nc-meta-item span{display:block;color:#8290a3;font-size:9px;font-weight:750;text-transform:uppercase}.nc-meta-item b{display:block;margin-top:4px;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nc-card-actions{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:12px;padding-top:11px;border-top:1px solid #edf0f4}.nc-empty{text-align:center;padding:38px 15px;color:#8290a3}.nc-empty strong{display:block;color:#d9e1ea;margin-bottom:5px}.nc-toast{padding:11px 13px;border-radius:11px;margin-bottom:13px;background:#0b241e;border:1px solid #1c5548;color:#59e0b8}.nc-danger{background:#0d141e4f6!important;color:#ff9bab!important;border:1px solid #60303b!important}.nc-warning{background:#0d141e9ed!important;color:#f3c55e!important;border:1px solid #5c4a20!important}
